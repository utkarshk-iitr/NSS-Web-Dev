      ...
      <div className="animate-fadeIn">
        <div className="flex flex-col md:flex-row md:items-center md:justify-between mb-8">
          <div>
            ...
            <p className="text-gray-500 dark:text-gray-400 mt-1">View and manage registered users</p>
          </div>
          <button
        ...
        <div className="bg-white dark:bg-gray-800 rounded-xl shadow-sm p-4 mb-6">
          ...
          {/* Filter Options */}
          {showFilters && (
            <div className="mt-4 pt-4 border-t dark:border-gray-700 grid md:grid-cols-4 gap-4">
              <div>
        ...
        <div className="bg-white dark:bg-gray-800 rounded-xl shadow-sm overflow-hidden">
          {loading ? (
                ...
                <table className="w-full">
                  <thead className="bg-gray-50 dark:bg-gray-700">
                    <tr>
                      ...
                      <th className="px-6 py-3 text-left text-xs font-medium text-gray-500 dark:text-gray-300 uppercase">Donations</th>
                  ...
                  <tbody className="divide-y divide-gray-200 dark:divide-gray-700">
                    {users.map((user) => (
                      <tr key={user._id} className="hover:bg-gray-50 dark:hover:bg-gray-700/50">
                        ...
                        <td className="px-6 py-4">
                          <span className={`badge ${user.isActive ? 'badge-success' : 'bg-gray-100 dark:bg-gray-600 text-gray-600 dark:text-gray-300'}`}>
                        ...
                        <td className="px-6 py-4">
                          <div className="flex items-center space-x-3">
                            <button
                              ...
                              className={`${user.isActive ? 'text-orange-600 hover:text-orange-700 dark:text-orange-400 dark:hover:text-orange-300' : 'text-green-600 hover:text-green-700 dark:text-green-400 dark:hover:text-green-300'} text-sm font-medium`}
                            >
            ...
            <div className="text-center py-12">
              <FiUser className="mx-auto text-4xl text-gray-300 dark:text-gray-600 mb-3" />
            ...
            <div className="bg-white dark:bg-gray-800 rounded-xl max-w-2xl w-full max-h-[90vh] overflow-y-auto">
              ...
              <div className="p-6">
                <div className="flex items-center mb-6">
                  ...
                  <div>
                    <h4 className="text-xl font-semibold text-gray-900 dark:text-white">{selectedUser.user?.name}</h4>
                    <p className="text-gray-500 dark:text-gray-400">{selectedUser.user?.email}</p>
                  </div>
                </div>
                ...
                <div className="grid md:grid-cols-2 gap-4 mb-6">
                  <div className="flex items-center space-x-3 p-3 bg-gray-50 dark:bg-gray-700 rounded-lg">
                    ...
                    <div>
                      ...
                      <p className="font-medium text-gray-900 dark:text-white">{selectedUser.user?.phone || 'Not provided'}</p>
                    </div>
                  </div>
                  <div className="flex items-center space-x-3 p-3 bg-gray-50 dark:bg-gray-700 rounded-lg">
                    ...
                    <div>
                      ...
                      <p className={`font-medium ${selectedUser.user?.isActive ? 'text-green-600 dark:text-green-400' : 'text-red-600 dark:text-red-400'}`}>
                ...
                <div>
                  <h5 className="font-medium text-gray-900 dark:text-white mb-2">Donation Summary</h5>
                  <div className="grid grid-cols-3 gap-4">
                    {selectedUser.donationStats?.map((stat) => (
                      <div key={stat._id} className="text-center p-3 bg-gray-50 dark:bg-gray-700 rounded-lg">
                        <p className={`text-lg font-bold ${
                          stat._id === 'success' ? 'text-green-600 dark:text-green-400' :
                          stat._id === 'pending' ? 'text-yellow-600 dark:text-yellow-400' : 'text-red-600 dark:text-red-400'
                        }`}>
                          {stat.count}
                        </p>
                        <p className="text-xs text-gray-500 dark:text-gray-400 capitalize">{stat._id}</p>
                        {stat._id === 'success' && (
                          <p className="text-xs text-gray-400 dark:text-gray-500">₹{stat.totalAmount?.toLocaleString()}</p>
                        )}
                      </div>
                    ))}
                  </div>
        ...
        {deleteConfirm && (
          <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
            <div className="bg-white dark:bg-gray-800 rounded-xl max-w-md w-full p-6 animate-fadeIn">
              <div className="text-center">
                ...
                <p className="text-gray-500 dark:text-gray-400 mb-2">
                  Are you sure you want to delete <span className="font-medium text-gray-900 dark:text-white">"{deleteConfirm.userName}"</span>?
                </p>
